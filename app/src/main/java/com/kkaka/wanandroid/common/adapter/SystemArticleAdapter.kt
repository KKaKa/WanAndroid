 ...
 * @description
 */
class SystemArticleAdapter(manager : FragmentManager, private val titles : List<String>, private val fragemtns : List<Fragment>) : FragmentStatePagerAdapter(manager) {
